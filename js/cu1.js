(function() {
    // VARS
    const productsContainer1 = document.querySelector("#myDIV ");
    const cartContainer1 = document.querySelector("#shopping-cart");
    const cartContent = document.querySelector("#cart-content");
    const toggleCartBtn = document.querySelector("#toggle-cart-btn");
    const clearCartBtn = document.querySelector("#clear-cart");
    const checkoutBtn = document.querySelector("#checkout-btn");
    const totalPriceContainer1 = document.querySelector("#total-price");
  
    // FUNCTIONS
  
    function toggleCart() {
      // toggle shopping cart visibility
      cartContainer1.classList.toggle("open");
    }
    ...
    function displayCartTotal() {
      ...
      if (prices) {
        ...
        totalPriceContainer1.innerHTML = `<span class="total">Total: R$${total.toFixed(
          2
        )}</span>`;
      } else {
        totalPriceContainer1.innerHTML = '<span class="total">Total: R$0</span>';
      }
    }
    ...
    function displayProducts() {
      ...
      if (lsContent !== null) {
        ...
        productMarkup = "Seu carrinho está vazio.";
      }
      // add markup to DOM
    ...
    function checkout() {
      ...
      if (cartProducts !== "" && confirm("Você tem certeza que quer finalizar a compra?")) {
        clearCart();
      } else {
        return;
      }
    ...
    productsContainer1.addEventListener("click", function(e) {
